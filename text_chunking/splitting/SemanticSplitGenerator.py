...
class SemanticSplitGenerator:
    ...
    def build_semantic_group_summaries(
        ...
        if isinstance(semantic_groups_to_summarize, dict):
            semantic_groups_to_summarize = list(semantic_groups_to_summarize.values())
        ...
        summary_dict = {}
        for idx, texts in enumerate(semantic_groups_to_summarize):
            summary_dict[idx] = {"summary": summaries[idx], "text": texts}
